...
// module reading a page reads it the way the editor does without importing `ose:editor`.
...
/** `parseSystems` and `readJsonl` under the names docs/KERNEL.md gives them. */
export { parseSystemsLog as parseSystems, parseJsonl as readJsonl };
