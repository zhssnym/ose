...
/**
 * `choose({ title, body, options, cancel })` (docs/KERNEL.md `ose:ui`): one question, a short
...
// (the stock sidebar, which narrows it to the focused folder) and reaches the kernel through
